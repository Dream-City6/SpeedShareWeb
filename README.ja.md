...
<a href="https://github.com/Dream-City6/SpeedShareWeb/releases/download/v1.4.1/SpeedShareWeb-v1.4.1.apk">
  <img src="https://img.shields.io/badge/ダウンロード-SpeedShareWeb%20v1.4.1%20APK-2ea44f?style=for-the-badge&logo=android&logoColor=white" alt="SpeedShareWeb v1.4.1 APKをダウンロード">
</a>

<br><br>

v1.4.1 では、Androidのホーム画面と設定画面をさらに使いやすくし、3言語のレイアウトと画面切り替えを改善し、より多くの端末でライト/ダーク表示の可読性を修正しました。
