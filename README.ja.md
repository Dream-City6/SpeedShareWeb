...
<a href="https://github.com/Dream-City6/SpeedShareWeb/releases/download/v1.4.0/SpeedShareWeb-v1.4.0.apk">
  <img src="https://img.shields.io/badge/ダウンロード-SpeedShareWeb%20v1.4.0%20APK-2ea44f?style=for-the-badge&logo=android&logoColor=white" alt="SpeedShareWeb v1.4.0 APKをダウンロード">
</a>

<br><br>

v1.4.0 では、新しいブランドアイコンと起動画面、スマートフォン・タブレット・ブラウザ向けのレスポンシブUI、システム安全領域への対応、明確な転送進捗、GPUによる滑らかな設定画面の切り替えを追加しました。
...
- v1.4.0：新しいブランドアイコンと起動画面、レスポンシブなオーロラUI、安全領域対応、リアルタイム転送進捗、滑らかなGPU設定画面切り替えを追加しました。
