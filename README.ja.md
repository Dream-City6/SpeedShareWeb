...
<a href="https://github.com/Dream-City6/SpeedShareWeb/releases/download/v1.3.2/SpeedShareWeb-v1.3.2.apk">
  <img src="https://img.shields.io/badge/ダウンロード-SpeedShareWeb%20v1.3.2%20APK-2ea44f?style=for-the-badge&logo=android&logoColor=white" alt="SpeedShareWeb v1.3.2 APKをダウンロード">
</a>

<br><br>

v1.3.2 では、デスクトップの右クリックとスマートフォンの長押しメニュー、安全なクイック操作、アップロード項目の個別削除、範囲選択、大規模フォルダー表示の最適化を追加しました。
