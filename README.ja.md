...
<a href="https://github.com/Dream-City6/SpeedShareWeb/releases/download/v1.3.1/SpeedShareWeb-v1.3.1.apk">
  <img src="https://img.shields.io/badge/ダウンロード-SpeedShareWeb%20v1.3.1%20APK-2ea44f?style=for-the-badge&logo=android&logoColor=white" alt="SpeedShareWeb v1.3.1 APKをダウンロード">
</a>

<br><br>

v1.3.1 では、再開可能なブラウザアップロードを大きなファイル向けに調整し、より大きなチャンク、少ない中間ディスク同期、ファイル全体に沿った安定した進捗表示に改善しました。
