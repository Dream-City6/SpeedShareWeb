...
<a href="https://github.com/Dream-City6/SpeedShareWeb/releases/download/v1.3.4/SpeedShareWeb-v1.3.4.apk">
  <img src="https://img.shields.io/badge/ダウンロード-SpeedShareWeb%20v1.3.4%20APK-2ea44f?style=for-the-badge&logo=android&logoColor=white" alt="SpeedShareWeb v1.3.4 APKをダウンロード">
</a>

<br><br>

v1.3.4 では、端末の空き容量とアップロード予定サイズを表示し、Android 用に 256 MB を確保したうえでブラウザとサーバーの両方で容量を確認します。アクセス保護が有効な場合は、パスワードだけを入力するログイン画面を使用します。
