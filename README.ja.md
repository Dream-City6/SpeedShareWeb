...
<a href="https://github.com/Dream-City6/SpeedShareWeb/releases/download/v1.3.3/SpeedShareWeb-v1.3.3.apk">
  <img src="https://img.shields.io/badge/ダウンロード-SpeedShareWeb%20v1.3.3%20APK-2ea44f?style=for-the-badge&logo=android&logoColor=white" alt="SpeedShareWeb v1.3.3 APKをダウンロード">
</a>

<br><br>

v1.3.3 では、初期設定でオフの任意パスワード保護とサーバー接続保護を追加し、並列アップロードが更新で中断される問題と、ストレージ間のごみ箱・復元処理の安全性を改善しました。
