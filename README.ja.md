...
<a href="https://github.com/Dream-City6/SpeedShareWeb/releases/download/v1.2.0/SpeedShareWeb-v1.2.0.apk">
  <img src="https://img.shields.io/badge/ダウンロード-SpeedShareWeb%20v1.2.0%20APK-2ea44f?style=for-the-badge&logo=android&logoColor=white" alt="SpeedShareWeb v1.2.0 APKをダウンロード">
</a>

<br><br>

v1.2.0 では、転送履歴、フォルダー構造を保持したアップロード、ドラッグ＆ドロップ対応、Android・ブラウザインターフェースの改善を追加しました。
