...
v1.4.0 では、新しいブランドアイコンと起動画面、レスポンシブUI、選択可能な外観モード、状態に応じた共有操作、開ける転送履歴、明確な進捗表示、滑らかな画面切り替えを追加しました。
...
- v1.4.0：新しいブランドアイコンと起動画面、レスポンシブなオーロラUI、安全領域対応、外観モード、共有操作、開ける転送履歴、滑らかな画面切り替えを追加しました。
