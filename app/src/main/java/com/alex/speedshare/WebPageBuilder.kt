            ...
            <head>
              ...
              <style>
                ...
                *{box-sizing:border-box}
                ...
                .managerModal,.dialogModal{position:fixed;inset:0;background:rgba(3,6,15,.76);display:none;align-items:center;justify-content:center;padding:18px;backdrop-filter:blur(10px)}.managerModal{z-index:180}.dialogModal{z-index:280}.managerModal.open,.dialogModal.open{display:flex;animation:modalFade .18s ease-out}.managerModal.open .managerPanel,.dialogModal.open .dialogPanel{animation:panelIn .22s cubic-bezier(.2,.8,.2,1)}
